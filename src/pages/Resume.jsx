...
export default function Resume() {
  ...
  useEffect(() => {
    ...
    // Simulate a short load time (optional)
  ...
  return (
    <section className="relative rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl p-10">
      ...
      {/* Header */}
      <h1 className="text-4xl font-bold text-white">Career Snapshot</h1>
      ...
      <div className="mt-10">
        ...
        <div className="pl-6 border-l border-cyan-400/40">
          <h3 className="text-lg font-semibold text-white">Bachelor of Computer Application (BCA)</h3>
          <p className="text-gray-400">Dr. Ram Manohar Lohia Awadh University, Ayodhya (UP)</p>
        </div>
        <div className="pl-6 border-l border-cyan-400/40">
          <h3 className="text-lg font-semibold text-white">Master of Computer Application (MCA)</h3>
      ...
      <div className="mt-12">
        ...
        <div className="space-y-8 pl-6 border-l border-cyan-400/40">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">May 2023 – Dec 2025</p>
            <p className="text-gray-300">
              Led technical initiatives in web and application development, deployment, and maintenance of multiple CPCB portals and internal tools.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">Jun 2020 – Apr 2023</p>
            <p className="text-gray-300">
              Developed and maintained full-stack applications, ensuring optimized performance, scalability, and secure deployments.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">Mar 2018 – Apr 2020</p>
            <p className="text-gray-300">
              Built and deployed web and mobile solutions across multiple projects using modern frontend and backend technologies.
            </p>
          </div>
        </div>
      </div>
